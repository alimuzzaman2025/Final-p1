            ...
            <Container>
                <div className='flex items-center'>
                    ...
                    <div className='w-1/4 relative'>
                        ...
                        {cartShow &&
                        <div className='w-[270px] absolute top-[48px] left-[62px] py-2 z-[2]'>
                            <div>
                                <div className='flex gap-3 items-center pl-2 bg-[#F5F5F3] py-2'>
                                    <div className='w-[80px] h-[80px]'>
                                        <img src={Crtboximage} alt="" />
                                    </div>
                                ...
                                <div className=''>
                                    ...
                                    <div className='flex px-2 py-[20px] gap-5 justify-between'>
                                        ...
                                        <div className=''>
                                            <button className=''><a className="py-2 px-5 border-2 border-[#000] bg-[#000] text-[#fff] hover:bg-[#fff] hover:text-[#000]" href="">Checkout</a></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
